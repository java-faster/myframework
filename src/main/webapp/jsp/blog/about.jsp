...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
    	<div id="templatemo_content" class="left">
          ...
          <div class="col col_2">
            <h5>Ut Non Nibh</h5>
            Ut non nibh vel leo dapibus gravida et at dolor. Nullam non turpis eros, non euismod velit. Quisque tristique turpis eu sapien pharetra nec varius urna eleifend. Cras eu elit hendrerit eros iaculis molestie. Aliquam erat volutpat. Validate <a href="#" ><strong>XHTML</strong></a> &amp; <a href="#" ><strong>CSS</strong></a>.</div>
		...
		<div id="templatemo_sidebar" class="right">
			...
			<div class="sidebar_section">
                <h2>Services</h2>
                <img src="${pageContext.request.contextPath}/images/templatemo_image_01.jpg" alt="image" class="img_nom img_border" />
        ...
        <div class="col col_3">
        	<h4>Twitter</h4>
      		<ul class="nobullet twitter">
                ...
                <li><a href="#" title="visit cn.mystockphoto.com" class="rower"  target="_blank">visit cn.mystockphoto.com</a></li>
            </ul>
        </div>
