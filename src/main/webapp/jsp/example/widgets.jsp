	     ...
	     <div class="widget_head">Widgets</div>
		   ...
		   <div class="widget_4">
				...
				<div class="coffee-top">
					<a href="#"><img class="img-responsive" src="${pageContext.request.contextPath}/images/pic4.jpg" alt="">
					<div class="doe">
						<h6>Lorem Ipusm</h6>
						<p>Web Designer</p>
					</div>
		   	 ...
		   	 <div class="col-md-4 stats-info3"> 
					...
					<a href="#"><div class="online-top">
						<div class="top-at">
							<img class="img-responsive" src="${pageContext.request.contextPath}/images/2.png" alt="">
						</div>
						<div class="top-on">
							<div class="top-on1">
								<p>Characteristic</p>
					...
					<a href="#"><div class="online-top">
						<div class="top-at">
							<img class="img-responsive" src="${pageContext.request.contextPath}/images/3.png" alt="">
						</div>
						<div class="top-on">
							<div class="top-on1">
								<p>Accompanied</p>
					...
					<a href="#"><div class="online-top">
						<div class="top-at">
							<img class="img-responsive" src="${pageContext.request.contextPath}/images/4.png" alt="">
						</div>
						<div class="top-on">
							<div class="top-on1">
								<p>Adipiscing</p>
					...
					<a href="#"><div class="online-top online-top1">
						<div class="top-at">
							<img class="img-responsive" src="${pageContext.request.contextPath}/images/1.png" alt="">
						</div>
						<div class="top-on">
							<div class="top-on1">
								<p>Denouncing</p>
		   	 ...
		   	 <div class="col-md-6 widget_1_box2">
		   	 	...
		   	 	<div class="wid_blog-desc">
		   	 		<div class="wid_blog-left">
		   	 			<img src="${pageContext.request.contextPath}/images/1.png" class="img-responsive" alt="">
		   	 		</div>
