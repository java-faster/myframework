            ...
            <div class="tm-sidebar">
                ...
                <nav class="tm-main-nav">
                    <ul>
                        ...
                        <li class="tm-nav-item"><a href="#about" class="tm-nav-item-link">主人介绍</a></li>
                        <li class="tm-nav-item"><a href="#ideas" class="tm-nav-item-link">生活点滴</a></li>
                        <li class="tm-nav-item"><a href="#contact" class="tm-nav-item-link">联系我们</a></li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="tm-main-content">
                ...
                <section id="home" class="tm-content-box tm-banner margin-b-10">
                    <div class="tm-banner-inner">
                        <h2 class="tm-banner-title">葛宏斌的家</h2>
                        <p class="tm-banner-text">by ptghb</p>    
                    </div>                    
                </section>
                ...
                <section>
                    <div class="tm-content-box flex-2-col">
                        ...
                        <div class="pad flex-item tm-team-description-container">
                            <h4 class="tm-section-title">男主</h4>
                            <p class="tm-section-description">葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌葛宏斌</p>
                            <h4 class="tm-section-title">女主</h4>
                            <p class="tm-section-description">姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆姚奕帆</p>    
                        </div>
                        <div class="flex-item">
                    ...
                    <div id="contact" class="pad">
                        ...
                        <form action="#contact" method="get" class="contact-form">
                            ...
                            <div class="form-group">
                                <input type="text" id="contact_subject" name="contact_subject" class="form-control" placeholder="标题"  required/>
                            </div>
                            <div class="form-group">
                                <textarea id="contact_message" name="contact_message" class="form-control" rows="9" placeholder="信息" required></textarea>
                            </div>
                            
                            <button type="submit" class="btn btn-primary submit-btn">发送</button>
                ...
                <footer class="tm-footer">
                    <p class="text-xs-center">Copyright &copy; 2016 Company Name 葛宏斌
